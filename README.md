...
automacao-parabank/
│
├── Locators/                # Arquivos contendo locators (.yml)
│   ├── cadastro_locators.yml
│   └── home_locators.yml
│
├── Pages/                   # Page Objects — ações que usam locators
│   ├── cadastro_page.robot
│   └── home_page.robot
│
├── Results/                 # Saída da execução dos testes
│   ├── log.html
│   ├── output.xml
│   └── report.html
│
...
│
├── Tests/                   # Casos de teste em formato BDD
│   └── cadastro.robot
│
├── Utils/                   # Recursos auxiliares e bibliotecas
│   ├── gerar_dados_fake.robot
│   ├── open_browser.robot
│   └── resource.robot
│
├── .gitignore
